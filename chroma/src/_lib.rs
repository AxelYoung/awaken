...
const VERTICES: &[Vertex] = &[
   ...
   Vertex {
      position: [-32.0 / SCREEN_WIDTH as f32 - 2.0, -32.0 / SCREEN_HEIGHT as f32 - 2.0, 0.0],
      tex_coords: [0.0, 1.0 / SPRITE_SHEET_HEIGHT as f32],
   }, 
   Vertex {
      position: [32.0 / SCREEN_WIDTH as f32 - 2.0, -32.0 / SCREEN_HEIGHT as f32 - 2.0, 0.0],
      tex_coords: [1.0 / SPRITE_SHEET_WIDTH as f32, 1.0 / SPRITE_SHEET_HEIGHT as f32],
   }, 
   Vertex {
      position: [32.0 / SCREEN_WIDTH as f32 - 2.0, 32.0 / SCREEN_HEIGHT as f32 - 2.0, 0.0],
      tex_coords: [1.0 / SPRITE_SHEET_WIDTH as f32, 0.0 ],
   }, 
...
impl Chroma {
   ...
   pub fn add_tile(&mut self, pos_x: f32, pos_y: f32, z: f32, index_x: u32, index_y: u32) {
      self.instances.push(
         Instance { 
