...
pub const MAP_TILE_WIDTH: usize = MAP_ROOM_WIDTH as usize * ROOM_TILE_WIDTH as usize;
pub const MAP_TILE_HEIGHT: usize = MAP_ROOM_HEIGHT as usize * ROOM_TILE_HEIGHT as usize;
...
fn create_player_spawn(game: &mut Game, cell: Cell, clone: usize) {
    ...
    game.world.add_component_to_entity(player_spawn, Sprite::new(clone as u32, 6, 0));
}
